...
const LocationAmenities: FunctionComponent = () => {
  return (
    <div className={styles.locationAmenities}>
      ...
      <div className={styles.lakesideFrame}>
        <div className={styles.frameParent}>
          <div className={styles.frameGroup}>
            <div className={styles.whereYoullBeParent}>
              ...
              <div className={styles.theBridlePath}>
                <img
                  className={styles.weatherInfoFrame}
                  alt=""
                  src="/vector-3.svg"
                />
                <div className={styles.theBridlePath1}>The Bridle Path</div>
              </div>
            </div>
          ...
          <img
            className={styles.userGuestsFrame}
            alt=""
            src="/user-guests-frame@2x.png"
          />
          <img
